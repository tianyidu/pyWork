...
model.add(Activation("relu"))
model.add(Conv2D(80,(3,3),padding="SAME",kernel_initializer=TruncatedNormal(stddev=1e-1,mean=0.001),name="conv3_3"))
model.add(Activation("relu"))
...
model.add(Activation("relu"))
model.add(Conv2D(100,(3,3),padding="SAME",kernel_initializer=TruncatedNormal(stddev=1e-1,mean=0.001),name="conv4_3"))
model.add(Activation("relu"))
